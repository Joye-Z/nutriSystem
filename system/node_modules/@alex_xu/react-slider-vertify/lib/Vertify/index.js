...
var _default = /*#__PURE__*/(0, _react.memo)(function (_ref) {
  var _ref$width = _ref.width,
      ...
      refreshIcon = _ref$refreshIcon === void 0 ? 'http://cdn.dooring.cn/dr/icon12.png' : _ref$refreshIcon,
      _ref$visible = _ref.visible,
      visible = _ref$visible === void 0 ? true : _ref$visible,
      onDraw = _ref.onDraw,
      onCustomVertify = _ref.onCustomVertify,
      onBeforeRefresh = _ref.onBeforeRefresh,
  ...
  var getRandomImgSrc = function getRandomImgSrc() {
    return imgUrl || "https://picsum.photos/id/".concat((0, _tool.getRandomNumberByRange)(0, 1084), "/").concat(width, "/").concat(height);
  };
      ...
      if (isIE) {
        ...
        xhr.onloadend = function (e) {
          ...
          file.onloadend = function (e) {
            ...
            img.src = e === null || e === void 0 ? void 0 : (_e$target = e.target) === null || _e$target === void 0 ? void 0 : _e$target.result;
          };
        };
  ...
  var draw = function draw(img) {
    ...
    yRef.current = (0, _tool.getRandomNumberByRange)(10 + r * 2, height - (L + 10));
  ...
  var reset = function reset() {
    ...
    onBeforeRefresh && onBeforeRefresh(); // 重新加载图片
  ...
  var verify = function verify() {
    ...
    var stddev = Math.sqrt(deviations.map(_tool.square).reduce(_tool.sum) / arr.length);
  ...
  }, textTip)), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }), /*#__PURE__*/_react.default.createElement("span", null, "\u52A0\u8F7D\u4E2D...")));
});
